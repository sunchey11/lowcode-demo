...
const productPath = `/ebeit_remote_table@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('ebeit_remote_table', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'ebeit_remote_table': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
